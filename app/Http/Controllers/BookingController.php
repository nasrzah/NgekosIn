...
class BookingController extends Controller
{
    ...
    {
        $this->transactionRepository->saveTransactionDataFromSession($request->all());
    ...
    public function saveInformation(CustomerInformationStoreRequest $request, $slug) {
        ...
        $this->transactionRepository->saveTransactionDataFromSession($data);
    ...
    public function payment(Request $request)
    {
        ...
        $paymmentUrl = \Midtrans\Snap::createTransaction($params)->redirect_url;
